...
<div class="container"> 
  <h2 class="text-center">Uy turini tanlang</h2> 
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="/admin/flatcode" method="POST">
          @csrf 
              <div class="mb-12">
                <label for="recipient-name" class="col-form-label">Uy turi:</label>
                <input type="text" class="form-control" id="flat" placeholder="Enter flat" name="flat">
              </div>
            </div>
            ...
            <tr class="text-center">
              ...
              <td>
                <div class="btn-group" role="group" aria-label="Basic example">
                   <form action="/adminedit/flatdelete"><input type="hidden" value="{{$flat->id}}" name="id" ><button type="submit" class="btn btn-danger"><i class="bi bi-trash"></i>Delete</button></form>
                </div>
             </td>
            </tr>
          @endforeach
